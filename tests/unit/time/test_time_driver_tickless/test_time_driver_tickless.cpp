...
TEST_F(TicklessDriverTest, ScheduleRecurringNullCallbackReturnsInvalidHandle)
{
...
TEST_F(TicklessDriverTest, ScheduleRecurringZeroIntervalReturnsInvalidHandle)
{
   std::atomic<int> count{0};
...
TEST_F(TicklessDriverTest, RejectedRecurringRequestsDoNotConsumeSlots)
{
   std::atomic<int> count{0};
...
TEST_F(TicklessDriverTest, ScheduleRecurringBeyondCapacityReturnsInvalidHandle)
{
   std::atomic<int> count{0};
...
TEST_F(TicklessDriverTest, ToMillisecondsInvertsFromMilliseconds)
{
...
TEST_F(TicklessDriverTest, ToMillisecondsRoundsToNearest)
{
...
TEST_F(TicklessDriverTest, ToMicrosecondsInvertsFromMicroseconds)
{
